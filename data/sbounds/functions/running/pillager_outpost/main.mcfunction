...
#debug
tellraw @a[tag=sbounds.debug] ["",{"text":"Trying to spawn ","color":"gray"},{"score":{"name":"%rand","objective":"sbounds.dummy"},"color":"gray"},{"text":" Pillagers","color":"gray"}]

#run spawning
function sbounds:running/pillager_outpost/spawn