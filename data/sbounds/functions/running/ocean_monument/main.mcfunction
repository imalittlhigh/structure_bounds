...
#debug
tellraw @a[tag=sbounds.debug] ["",{"text":"Trying to spawn ","color":"gray"},{"score":{"name":"%rand","objective":"sbounds.dummy"},"color":"gray"},{"text":" Guardians","color":"gray"}]

#run spawning
function sbounds:running/ocean_monument/spawn